...
public class RegisterDefs extends BasedriverConfiguration {
    ...
    public void the_register_button_is_clicked() throws Throwable {
        Thread.sleep(1000);
//        WebElement registerForm = browser.findElement(id("registerForm"));
//        registerForm.submit();
        WebElement submitButton = browser.findElement(id("signUp"));

        submitButton.click();
//        Actions ob = new Actions(browser);
//        ob.click(submitButton);
